                      ...
                      <div className="card mb-3 mx-auto  text-light">
                          <div className="row g-0">
                              <div className="col-md-4">
                                  ...
                                  <p className="card-desc"><img src={iconUrl}  className="logo" alt="icon"/>{weather.weather[0].description}</p>
                                  <img src="https://us.123rf.com/450wm/halynamoroshan/halynamoroshan2003/halynamoroshan200300035/143343751-ilustraci%C3%B3n-de-im%C3%A1genes-del-tiempo.jpg?ver=6"width={450} height={230} className="img-fluid rounded-start" alt="..."/>
                              </div>
                              <div className="col-md-8">
                                  <div className="card-body text-start mt-2">
                                      <h5 className="card-text">Temperatura máxima: {(weather.main.temp_max - 273.15).toFixed(1)}ºC</h5>
                                      <h5 className="card-text">Temperatura mínminima: {(weather.main.temp_min - 273.15).toFixed(1)}ºC</h5>
